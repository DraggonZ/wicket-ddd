...
public class ChangeAccountPersonCommand extends ApplicationCommand {
    ...
    public ChangeAccountPersonCommand(String id) {
        this(id, null, null, null, null);
    }

    public ChangeAccountPersonCommand(String id, String title, String firstName, String middleName, String lastName) {
        this.id = id;
        setTitle(title);
